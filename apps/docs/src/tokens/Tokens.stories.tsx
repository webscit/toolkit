      ...
      <div>
        <div
          style={{
            ...
            fontWeight: "var(--sct-font-weight-medium)" as never,
          }}
        >
          {name}
        </div>
...
export const Colors: Story = {
  render: () => (
    <div>
      <h2
        style={{
          fontSize: "var(--sct-font-size-xl)",
          fontWeight: "var(--sct-font-weight-semibold)" as never,
          marginBottom: "16px",
        }}
      >
        Color Tokens
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        {fontWeightTokens.map((w) => (
          ...
          >
            ...
            <div
              style={{
                fontWeight: `var(--sct-font-weight-${w})` as never,
                fontSize: "var(--sct-font-size-base)",
              }}
            >
