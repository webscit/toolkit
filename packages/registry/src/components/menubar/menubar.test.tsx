...
import { Menubar, MenubarMenu, MenubarTrigger, MenubarContent, MenubarItem, MenubarSeparator, MenubarLabel, MenubarShortcut } from "./menubar";
...
describe("Menubar", () => {
  ...
  it("popup is closed before trigger click", async () => {
    await render(
      <Menubar><MenubarMenu><MenubarTrigger>Edit</MenubarTrigger><MenubarContent><MenubarItem data-testid="item">Copy</MenubarItem></MenubarContent></MenubarMenu></Menubar>
    );
