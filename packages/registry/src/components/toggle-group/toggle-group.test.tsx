...
describe("ToggleGroup", () => {
  ...
  it("renders ToggleGroupItem as a button", async () => {
    const screen = await render(<ToggleGroup><ToggleGroupItem value="bold">Bold</ToggleGroupItem></ToggleGroup>);
  ...
  it("ToggleGroupItem forwards className", async () => {
    const screen = await render(<ToggleGroup><ToggleGroupItem value="bold" className="custom">Bold</ToggleGroupItem></ToggleGroup>);
