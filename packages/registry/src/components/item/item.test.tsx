...
describe("Item", () => {
  it("renders with scope class", async () => {
    ...
    expect(document.querySelector("[data-testid='it']")?.className).toBe(
      "sct-item",
    );
  });
  ...
  it("forwards className", async () => {
    await render(
      <Item className="custom" data-testid="it">
        Label
      </Item>,
    );
    expect(document.querySelector("[data-testid='it']")?.className).toBe(
  ...
  it("sets data-selected when selected=true", async () => {
    await render(
      <Item selected data-testid="it">
        Label
      </Item>,
    );
    expect(
      document
        .querySelector("[data-testid='it']")
