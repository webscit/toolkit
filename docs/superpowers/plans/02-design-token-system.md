  ...
  "sct": {
    ...
    "font": {
      "family": {
        ...
        "mono": { "$type": "fontFamily", "$value": "'SF Mono', 'Fira Code', 'Cascadia Code', monospace" }
      },
      "size": {
    ...
    "shadow": {
      "xs": { "$type": "shadow", "$value": { "offsetX": "0", "offsetY": "1px", "blur": "2px", "spread": "0", "color": "rgba(0,0,0,0.10)" } },
      "sm": { "$type": "shadow", "$value": { "offsetX": "0", "offsetY": "2px", "blur": "4px", "spread": "0", "color": "rgba(0,0,0,0.15)" } },
      "lg": { "$type": "shadow", "$value": { "offsetX": "0", "offsetY": "8px", "blur": "24px", "spread": "0", "color": "rgba(0,0,0,0.20)" } }
    }
  }
}
```
...
```json
{
  ...
  "sct": {
    "color": {
      ...
      "primary-foreground":   { "$type": "color", "$value": "{sct.color.neutral.0}" },
      "destructive":          { "$type": "color", "$value": "{sct.color.red.base}" },
      "destructive-foreground":{ "$type": "color", "$value": "{sct.color.neutral.0}" },
      ...
      "muted-foreground":     { "$type": "color", "$value": "{sct.color.neutral.500}" },
      "accent":               { "$type": "color", "$value": "{sct.color.neutral.100}" },
      "accent-foreground":    { "$type": "color", "$value": "{sct.color.neutral.950}" },
      ...
      "secondary-foreground": { "$type": "color", "$value": "{sct.color.neutral.950}" }
    }
  }
}
```
...
```json
{
  "sct": {
    "color": {
      ...
      "muted-foreground":     { "$type": "color", "$value": "{sct.color.neutral.400}" },
      "accent":               { "$type": "color", "$value": "{sct.color.neutral.700}" },
      "accent-foreground":    { "$type": "color", "$value": "{sct.color.neutral.200}" },
      ...
      "secondary-foreground": { "$type": "color", "$value": "{sct.color.neutral.200}" }
    }
  }
}
```
